...
func (c *Client) SubmitBlockAsync(block *cttutil.Block, options *btcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *cttutil.Block, options *btcjson.SubmitBlockOptions) error {
