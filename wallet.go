...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []cttutil.Address) FutureListUnspentResult {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []cttutil.Address) ([]btcjson.ListUnspentResult, error) {
...
func (c *Client) SetTxFeeAsync(fee cttutil.Amount) FutureSetTxFeeResult {
...
func (c *Client) SetTxFee(fee cttutil.Amount) error {
...
func (c *Client) SendToAddressAsync(address cttutil.Address, amount cttutil.Amount) FutureSendToAddressResult {
...
func (c *Client) SendToAddress(address cttutil.Address, amount cttutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address cttutil.Address,
	amount cttutil.Amount, comment,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address cttutil.Address, amount cttutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress cttutil.Address, amount cttutil.Amount) FutureSendFromResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress cttutil.Address, amount cttutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress cttutil.Address, amount cttutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress cttutil.Address, amount cttutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress cttutil.Address, amount cttutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress cttutil.Address,
	amount cttutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[cttutil.Address]cttutil.Amount) FutureSendManyResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[cttutil.Address]cttutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[cttutil.Address]cttutil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[cttutil.Address]cttutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (cttutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return cttutil.DecodeAddress(addr, &chaincfg.CTIndigoNetParams)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []cttutil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []cttutil.Address, account string) (cttutil.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []cttutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []cttutil.Address) (*btcjson.CreateMultiSigResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (cttutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddress(account string) (cttutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (cttutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (cttutil.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (cttutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddress(account string) (cttutil.Address, error) {
...
func (c *Client) GetAccountAsync(address cttutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetAccount(address cttutil.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address cttutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) SetAccount(address cttutil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]cttutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	addrs := make([]cttutil.Address, 0, len(addrStrings))
	for _, addrStr := range addrStrings {
		addr, err := cttutil.DecodeAddress(addrStr,
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]cttutil.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount cttutil.Amount) FutureMoveResult {
...
func (c *Client) Move(fromAccount, toAccount string, amount cttutil.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	amount cttutil.Amount, minConfirms int) FutureMoveResult {
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount cttutil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveCommentAsync(fromAccount, toAccount string,
	amount cttutil.Amount, minConfirms int, comment string) FutureMoveResult {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount cttutil.Amount,
...
func (c *Client) ValidateAddressAsync(address cttutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) ValidateAddress(address cttutil.Address) (*btcjson.ValidateAddressWalletResult, error) {
...
func (r FutureListAccountsResult) Receive() (map[string]cttutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]cttutil.Amount)
	for k, v := range accounts {
		amount, err := cttutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]cttutil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]cttutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (cttutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := cttutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (cttutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalance(account string) (cttutil.Amount, error) {
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (cttutil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (cttutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (cttutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (cttutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (cttutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (cttutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (cttutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address cttutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
// confirmations.
func (c *Client) GetReceivedByAddress(address cttutil.Address) (cttutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address cttutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetReceivedByAddressMinConf(address cttutil.Address, minConfirms int) (cttutil.Amount, error) {
...
func (c *Client) SignMessageAsync(address cttutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address cttutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address cttutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address cttutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*cttutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return cttutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address cttutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address cttutil.Address) (*cttutil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *cttutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *cttutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *cttutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *cttutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *cttutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *cttutil.WIF, label string, rescan bool) error {
